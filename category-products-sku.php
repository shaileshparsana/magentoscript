 ...
 * @author     Mydons
 */
class Plumtree_Shell_Categoryproductsku extends Mage_Shell_Abstract {
    ...
    public function run() {
        ...
        $file_handle = fopen("../vendor_feed/other_update/add_categories.csv", "r") or die("CSV file not found or not able to open it.");
		$key = array();
		$i = 1;
		
		$count =0;
		$fp = file('../vendor_feed/other_update/add_categories.csv', FILE_SKIP_EMPTY_LINES);
...
$shell = new Plumtree_Shell_Categoryproductsku();
$shell->run();