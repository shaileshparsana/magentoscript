<?php   
	...
	{ 
		...
		$file_path = $_SERVER['DOCUMENT_ROOT'].'/custom_script/export_all_products_la_store.csv'; //file path of the CSV file in which the $data to be saved
		...
		$products_ids = Mage::getModel('catalog/product')->getCollection()->addWebsiteFilter(5);
		...
		foreach ($products_ids as $pid)
		{
			...
			$data['store'] = 'Admin';
			$data['websites'] = Mage::app()->getWebsite(5)->getName();
