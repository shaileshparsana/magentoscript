...
var WebCodeCamJS = function(element) {
	...
	if (location.protocol === 'https:') {
    	var decodeurl = 'https://www.storeathome.biz/skin/frontend/default/storeathome/js/DecoderWorker.js';
	}
	else
	{
		var decodeurl = 'http://www.storeathome.biz/skin/frontend/default/storeathome/js/DecoderWorker.js';
	}
    var videoSelect, lastImageSrc, con, beepSound, w, h;
    var display = Q(element),
        DecodeWorker = new Worker('https://www.storeathome.biz/skin/frontend/default/storeathome/js/DecoderWorker.js'),
    ...
    function changeConstraints() {
        ...
        if (videoSelect && videoSelect.length !== 0) {
            switch (videoSelect[videoSelect.selectedIndex].value.toString()) {
                ...
                default:
                    constraints.video.optional = [{
                        sourceId: videoSelect[1].value  //custom code to open back camera
                    }];
                    break;
            }
        }
